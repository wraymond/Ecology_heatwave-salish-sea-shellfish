...
Compile and summarize air and water temperature data focused around the June 2021 heat wave. 
...
## Load Data
Import NOAA and logger data as applicable.
...
## Data managment
### Station
clean up and put data sets together all nice like
...
# Convert to MLLW #
#van.tide$v <- van.tide$v - 1.22
#cal.tide$v <- cal.tide$v - 1.01
...
### Exposure times
Extract times at each location where water was <= 1m. Will need to convert Canadian to MLLW.
...
ggplot(water.level.redu) +
  geom_line(aes(x = as.POSIXct(t), y = v), color = "#2B09D9", size = 0.75) +
  annotate("rect", xmin = as.POSIXct("2021-06-26 0:00:00"), xmax = as.POSIXct("2021-06-26 05:12:00"), ymin = -1, ymax = 5, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-26 21:11:00"), xmax = as.POSIXct("2021-06-27 05:12:00"), ymin = -1, ymax = 5, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-27 21:11:00"), xmax = as.POSIXct("2021-06-28 05:12:00"), ymin = -1, ymax = 5, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-28 21:11:00"), xmax = as.POSIXct("2021-06-29 00:00:00"), ymin = -1, ymax = 5, alpha = 0.1, fill = "black") +
  scale_y_continuous(limits = c(-1.5, 5), breaks = seq(-1, 5, by = 1)) +
  scale_x_datetime(breaks = seq(as.POSIXct("2021-06-26 00:00:00"), as.POSIXct("2021-06-29 00:00:00"), "1 day"), date_labels = "%D", limits = c(as.POSIXct("2021-06-26 00:00:00"), as.POSIXct("2021-06-29 00:00:00"))) +
  xlab("Date") +
  ylab("Water level (m)") +
  theme(legend.position = "none") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.text.y = element_text(size = 20)) +
  facet_wrap(~station.name.f, nrow = 3, ncol = 2)
...
ggplot(air.temp.redu.t) +
  ...
  geom_vline(xintercept = as.POSIXct("2021-06-27 13:15:00"), linetype = "dashed") +
  geom_vline(xintercept = as.POSIXct("2021-06-28 13:15:00"), linetype = "dashed") +
  annotate("rect", xmin = as.POSIXct("2021-06-24 00:00:00"), xmax = as.POSIXct("2021-06-24 05:12:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-24 21:11:00"), xmax = as.POSIXct("2021-06-25 05:12:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-25 21:11:00"), xmax = as.POSIXct("2021-06-26 05:12:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-26 21:11:00"), xmax = as.POSIXct("2021-06-27 05:12:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-27 21:11:00"), xmax = as.POSIXct("2021-06-28 05:12:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-28 21:11:00"), xmax = as.POSIXct("2021-06-29 05:12:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-29 21:11:00"), xmax = as.POSIXct("2021-06-30 05:12:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-30 21:11:00"), xmax = as.POSIXct("2021-07-01 00:00:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  facet_wrap(~station.name.f, nrow = 6, ncol = 1) +
  geom_hline(data = summer.grid.summary[, c(2, 3, 14)], aes(yintercept = avg.max), color = "#FF6803", size = 0.5) +
  geom_hline(data = summer.grid.summary[, c(5, 6, 14)], aes(yintercept = avg.min), color = "#03BCFF", size = 0.5) +
  geom_segment(data = water.level.exp, aes(y = 0, x = start, yend = 0, xend = end), color = "#663300", size = 2)

plot_grid(p.wl.facet, p.air.facet, nrow = 1, ncol = 2)

ggplot(air.temp.redu) +
  geom_line(aes(x = as.POSIXct(t), y = v), color = "#EB330E", size = 1) +
  annotate("rect", xmin = as.POSIXct("2021-06-26 0:00:00"), xmax = as.POSIXct("2021-06-26 05:12:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-26 21:11:00"), xmax = as.POSIXct("2021-06-27 05:12:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-27 21:11:00"), xmax = as.POSIXct("2021-06-28 05:12:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  annotate("rect", xmin = as.POSIXct("2021-06-28 21:11:00"), xmax = as.POSIXct("2021-06-29 00:00:00"), ymin = 0, ymax = 50, alpha = 0.1, fill = "black") +
  scale_y_continuous(limits = c(0, 50), breaks = seq(0, 50, by = 10)) +
  scale_x_datetime(breaks = seq(as.POSIXct("2021-06-26 00:00:00"), as.POSIXct("2021-06-29 00:00:00"), "1 day"), date_labels = "%D", limits = c(as.POSIXct("2021-06-26 00:00:00"), as.POSIXct("2021-06-29 00:00:00"))) +
  xlab("Date") +
  ylab("Air temperature (C)") +
